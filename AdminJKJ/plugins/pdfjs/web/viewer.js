...
function initPdfPrint(){
  var pdfTestContainer = document.getElementById('printContainerTmp');
  if(PDFViewerApplication.pdfDocument === null){
	  console.log('not found file!');
	  return false;
  }
  for (var i = 0, ii = PDFViewerApplication.pagesCount; i < ii; ++i) {
     var pdfPage = PDFViewerApplication.pdfViewer.getPageView(i).pdfPage;
     var viewport = pdfPage.getViewport(1);
     viewport.width = 980;
     viewport.height = 1400;
     var transform = [1.667,0,0,-1.667,0,1400];
     ...
     var canvasWrapper = document.createElement('div');
     canvasWrapper.style.width = '980px';
     canvasWrapper.style.height = '1400px';
     canvasWrapper.appendChild(canvas);
     pdfTestContainer.appendChild(canvasWrapper);
  }
}
